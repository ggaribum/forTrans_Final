...
public class Fragment_Show_Area extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //btn_goinside=(ImageButton)rootView.findViewById(R.id.btn_goinside);
            ...
            if (tempButton == newButton) {
                ...
                ll_select_area.setOnClickListener(new View.OnClickListener(){
                    ...
                    public void onClick(View view){
                        ...
                        //SelectActivity selectActivity=new SelectActivity(selectedArea);

                        Toast.makeText(getApplicationContext(),"<email,name : "+BaseActivity.email+","+BaseActivity.name+","+BaseActivity.isLogined,Toast.LENGTH_LONG).show();
